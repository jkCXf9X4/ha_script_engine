...
class _Script_NightLights(Engine):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.group_id = "group.night_lamps"
    ...
    def _script_turn_on_night_lights(self, *args, **kwargs):
        ...
        self.hass.services.call("light", "turn_on", target= {"entity_id" : self.group_id})
    ...
    def _script_turn_off_night_lights(self, *args, **kwargs):
        ...
        self.hass.services.call("light", "turn_off", target= {"entity_id" : self.group_id})
