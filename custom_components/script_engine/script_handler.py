from custom_components.script_engine import misc
import os
import fnmatch 
import logging
import runpy
...
class Script_handler:
    ...
    def extract_script_classes(self):
        def extract_class(script: Script_info):
            script_globals = runpy.run_path(path_name=script.path)
    ...
    def extract_script_functions(self, pattern):
        ...
        def extract_function(script: Script_info):
            ...
            script.script_function_objects, script.non_script_functions_object = misc.ListHelp.split_list(functions, is_script_function)
